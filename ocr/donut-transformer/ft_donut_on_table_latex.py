# -*- coding: utf-8 -*-
"""Fine_tune_Donut_on_a_custom_dataset_(CORD)_with_PyTorch_Lightning (2).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IcRExLWkbQGrDuy7BC2VxiztAeaAaass
...
trainer = pl.Trainer(
    ...
    logger=logger,
    callbacks=[save_model_callback, save_model_callback],  # 添加新的回调
)
...
processor = DonutProcessor.from_pretrained("/workspace/origin/result/model_final")
model = VisionEncoderDecoderModel.from_pretrained("/workspace/origin/result/model_final")
